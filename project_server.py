...
class ChatClient:
    def _init_(self):
        self.server_ip = '192.168.129.129'
        ...
        self.csv_file = 'response_times.csv' 
    ...
    def run(self):
        try:
            ...
            self.secondary_client_socket.connect((self.server_ip, self.server_port))
